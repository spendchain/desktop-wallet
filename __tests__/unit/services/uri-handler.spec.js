...
describe('URI Handler', () => {
  ...
  describe('deserialize', () => {
    ...
    it('should fill params', () => {
      const schema = new URIHandler('ark:DNjuJEDQkhrJ7cA9FZ2iVXt5anYiM8Jtc9?amount=1.2&label=Hello&vendorField=Spendchain&nethash=2a44f340d76ffc3df204c5f38cd355b7496c9065a1ade2ef92071436bd72e867&wallet=DSyG9hK9CE8eyfddUoEvsga4kNVQLdw2ve').deserialize()
      ...
      expect(schema.vendorField).toBe('Spendchain')
